...
insert into dependent values (333445555, 'Alice', 'F', '1986-04-05', 'Daughter', 15),
							 (333445555, 'Theodore', 'M', '1983-10-25', 'Son', 21),
                             (333445555, 'Joy', 'F', '1958-05-03', 'Spouse', 15),
                             (987654321, 'Abner', 'M', '1942-02-28', 'Spouse', 21),
                             (123456789, 'Michael', 'M', '1988-01-04', 'Son', 15),
                             (123456789, 'Alice', 'F', '1988-12-30', 'Daughter', 20),
                             (123456789, 'Elizabeth', 'F', '1967-05-05', 'Spouse', 20);

insert into departament values ('Research', 5, 333445555, '1988-05-22','1986-05-22'),
							   ('Administration', 4, 987654321, '1995-01-01','1994-01-01'),
                               ('Headquarters', 1, 888665555,'1981-06-19','1980-06-19');

insert into department_location values (1, 'Houston'),
								 (4, 'Stafford'),
                                 (5, 'Bellaire'),
                                 (5, 'Sugarland'),
                                 (5, 'Houston');
